!function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a="function"==typeof require&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}for(var i="function"==typeof require&&require,o=0;o<r.length;o++)s(r[o]);return s}({1:[function(require,module,exports){(function(global){global.$=global.jQuery=require("jquery"),require("bootstrap"),require("metismenu"),require("jquery-slimscroll"),require("jquery-toast-plugin"),require("dropify"),require("bootstrap-datepicker"),require("./utils/bootstrap-datepicker"),require("./utils/jquery.waypoints.min"),require("./utils/jquery.counterup.min"),require("sweetalert"),require("angular"),require("angular-ui-router"),require("angular-baidu-map");var yonglongApp=angular.module("myApp",["ui.router","baiduMap"]);yonglongApp.config(["$compileProvider",function($compileProvider){$compileProvider.debugInfoEnabled(!1)}]);var UiState=require("./utils/UiState");$(document).ready(function(){$(function(){$(".preloader").fadeOut()})}),!function(t){"use strict";function e(t){return null!==t&&t===t.window}function n(t){return e(t)?t:9===t.nodeType&&t.defaultView}function a(t){var e,a,i={top:0,left:0},o=t&&t.ownerDocument;return e=o.documentElement,"undefined"!=typeof t.getBoundingClientRect&&(i=t.getBoundingClientRect()),a=n(o),{top:i.top+a.pageYOffset-e.clientTop,left:i.left+a.pageXOffset-e.clientLeft}}function i(t){var e="";for(var n in t)t.hasOwnProperty(n)&&(e+=n+":"+t[n]+";");return e}function o(t){if(d.allowEvent(t)===!1)return null;for(var e=null,n=t.target||t.srcElement;null!==n.parentElement;){if(!(n instanceof SVGElement||-1===n.className.indexOf("waves-effect"))){e=n;break}if(n.classList.contains("waves-effect")){e=n;break}n=n.parentElement}return e}function r(e){var n=o(e);null!==n&&(c.show(e,n),"ontouchstart"in t&&(n.addEventListener("touchend",c.hide,!1),n.addEventListener("touchcancel",c.hide,!1)),n.addEventListener("mouseup",c.hide,!1),n.addEventListener("mouseleave",c.hide,!1))}var s=s||{},u=document.querySelectorAll.bind(document),c={duration:750,show:function(t,e){if(2===t.button)return!1;var n=e||this,o=document.createElement("div");o.className="waves-ripple",n.appendChild(o);var r=a(n),s=t.pageY-r.top,u=t.pageX-r.left,d="scale("+n.clientWidth/100*10+")";"touches"in t&&(s=t.touches[0].pageY-r.top,u=t.touches[0].pageX-r.left),o.setAttribute("data-hold",Date.now()),o.setAttribute("data-scale",d),o.setAttribute("data-x",u),o.setAttribute("data-y",s);var l={top:s+"px",left:u+"px"};o.className=o.className+" waves-notransition",o.setAttribute("style",i(l)),o.className=o.className.replace("waves-notransition",""),l["-webkit-transform"]=d,l["-moz-transform"]=d,l["-ms-transform"]=d,l["-o-transform"]=d,l.transform=d,l.opacity="1",l["-webkit-transition-duration"]=c.duration+"ms",l["-moz-transition-duration"]=c.duration+"ms",l["-o-transition-duration"]=c.duration+"ms",l["transition-duration"]=c.duration+"ms",l["-webkit-transition-timing-function"]="cubic-bezier(0.250, 0.460, 0.450, 0.940)",l["-moz-transition-timing-function"]="cubic-bezier(0.250, 0.460, 0.450, 0.940)",l["-o-transition-timing-function"]="cubic-bezier(0.250, 0.460, 0.450, 0.940)",l["transition-timing-function"]="cubic-bezier(0.250, 0.460, 0.450, 0.940)",o.setAttribute("style",i(l))},hide:function(t){d.touchup(t);var e=this,n=(1.4*e.clientWidth,null),a=e.getElementsByClassName("waves-ripple");if(!(a.length>0))return!1;n=a[a.length-1];var o=n.getAttribute("data-x"),r=n.getAttribute("data-y"),s=n.getAttribute("data-scale"),u=Date.now()-Number(n.getAttribute("data-hold")),l=350-u;0>l&&(l=0),setTimeout(function(){var t={top:r+"px",left:o+"px",opacity:"0","-webkit-transition-duration":c.duration+"ms","-moz-transition-duration":c.duration+"ms","-o-transition-duration":c.duration+"ms","transition-duration":c.duration+"ms","-webkit-transform":s,"-moz-transform":s,"-ms-transform":s,"-o-transform":s,transform:s};n.setAttribute("style",i(t)),setTimeout(function(){try{e.removeChild(n)}catch(t){return!1}},c.duration)},l)},wrapInput:function(t){for(var e=0;e<t.length;e++){var n=t[e];if("input"===n.tagName.toLowerCase()){var a=n.parentNode;if("i"===a.tagName.toLowerCase()&&-1!==a.className.indexOf("waves-effect"))continue;var i=document.createElement("i");i.className=n.className+" waves-input-wrapper";var o=n.getAttribute("style");o||(o=""),i.setAttribute("style",o),n.className="waves-button-input",n.removeAttribute("style"),a.replaceChild(i,n),i.appendChild(n)}}}},d={touches:0,allowEvent:function(t){var e=!0;return"touchstart"===t.type?d.touches+=1:"touchend"===t.type||"touchcancel"===t.type?setTimeout(function(){d.touches>0&&(d.touches-=1)},500):"mousedown"===t.type&&d.touches>0&&(e=!1),e},touchup:function(t){d.allowEvent(t)}};s.displayEffect=function(e){e=e||{},"duration"in e&&(c.duration=e.duration),c.wrapInput(u(".waves-effect")),"ontouchstart"in t&&document.body.addEventListener("touchstart",r,!1),document.body.addEventListener("mousedown",r,!1)},s.attach=function(e){"input"===e.tagName.toLowerCase()&&(c.wrapInput([e]),e=e.parentElement),"ontouchstart"in t&&e.addEventListener("touchstart",r,!1),e.addEventListener("mousedown",r,!1)},t.Waves=s,document.addEventListener("DOMContentLoaded",function(){s.displayEffect()},!1)}(window),yonglongApp.constant("AUTH_EVENTS",{loginSuccess:"auth-login-success",loginFailed:"auth-login-failed",logoutSuccess:"auth-logout-success",sessionTimeout:"auth-session-timeout",notAuthenticated:"auth-not-authenticated",notAuthorized:"auth-not-authorized"}),yonglongApp.value("diyData",{uapply:[{name:"审核通过",id:"0"},{name:"未审核",id:"1"}],ufriend:[{name:"进口",id:"0"},{name:"出口",id:"1"}],orderType:[{name:"进口",id:"0"},{name:"出口",id:"1"},{name:"拖柜进洋山",id:"2"}],boxType:[{name:"GP",id:"0",v:"GP"},{name:"HC",id:"1",v:"HC"},{name:"OT(开顶箱)",id:"2",v:"OT"},{name:"HT(挂衣箱)",id:"3",v:"HT"},{name:"RF(冷冻箱)",id:"4",v:"RF"},{name:"RH（l冷冻高箱）",id:"5",v:"RH"},{name:"TK（油罐箱）",id:"6",v:"TK"},{name:"FR（框架箱）",id:"7",v:"FR"}],boxTypeN:[{name:"不限",id:"-1",v:"不限"},{name:"GP",id:"0",v:"GP"},{name:"HC",id:"1",v:"HC"},{name:"OT(开顶箱)",id:"2",v:"OT"},{name:"HT(挂衣箱)",id:"3",v:"HT"},{name:"RF(冷冻箱)",id:"4",v:"RF"},{name:"RH（l冷冻高箱）",id:"5",v:"RH"},{name:"TK（油罐箱）",id:"6",v:"TK"},{name:"FR（框架箱）",id:"7",v:"FR"}],boxVol:[{name:"20",id:"0",show:"短板车"},{name:"40",id:"1",show:"12.6米"}],boxVolN:[{name:"不限",id:"-1",show:"不限"},{name:"20",id:"0",show:"短板车"},{name:"40",id:"1",show:"12.6米"}],orderTypeN:[{name:"不限",id:"-1"},{name:"进口",id:"0"},{name:"出口",id:"1"},{name:"拖柜进洋山",id:"2"}]}),yonglongApp.constant("rescode",{SUCCESS:"0000",AGAIN_PHONE:"201002",EMPTY_SMS_CODE:"201004"}),yonglongApp.constant("URL_CONS",{serverUrl:"http://120.26.65.65:8285/adm/api/data",serverFileUrl:" http://120.26.65.65:8285/adm/api/file",companyRegister:"company_register",companyCreateOrder:"company_create_order",companyOrderList:"company_list_order",companyListMyorder:"company_list_myorder",companyListGetorder:"company_list_getorder",deleteOrder:"company_delete_order",companyUserinfo:"company_userinfo",companyUserDetail:"company_user_detail",companyUpdateinfo:"company_updateinfo",busUserDetail:"bus_user_detail",fleetTakeOfferOrder:"fleetTakeOfferOrder",cancelOrder:"userCancelOfferOrder",companyListFriend:"company_list_friend",companyListBusowners:"company_list_busowners",companyAddFriend:"company_add_friend",companyDelFriend:"company_del_friend",accountInfo:"account_info",addBankCard:"addBankCard",listBankCard:"listBankCard",delBankCard:"delBankCard",listRefundApply:"listRefundApply",addRefundApply:"addRefundApply",cashList:"cashList",reportList:"report_list",userListGetorder:"user_list_getorder",userListMyorder:"user_list_myorder",userListDispatchorder:"user_list_dispatchorder",userRegister:"user_register",userUserinfo:"user_userinfo",userUpdateInfo:"user_updateinfo",userTakeOfferOrder:"userTakeOfferOrder",userOverOfferOrder:"userOverOfferOrder",userListFriend:"user_list_friend",userEditFriend:"user_edit_friend",userDispatchList:"user_dispatchList"}),yonglongApp.constant("USER_ROLES",{all:"*",admin:"admin",editor:"editor",guest:"guest"}),yonglongApp.filter("payStatusText",function(){return function(input){return"0"==input?"未付款":"1"==input?"已付款":void 0}}),yonglongApp.filter("friendType",function(){return function(str){return"0"==str?"未审核":"1"==str?"审核通过":"9"==str?"用户拒绝":void 0}}),yonglongApp.filter("emptyText",function(){return function(str){return""==str?"无":str}}),yonglongApp.filter("moneyText",function(){return function(str){return str+"元"}}),yonglongApp.filter("atmStatus",function(){return function(str){return"1"==str?"审核通过":"审核中"}}),yonglongApp.filter("boxVol",function(){return function(str){return"0"==str||0==str?"20":"1"==str||1==str?"40":"2"==str||2==str?"45":void 0}}),yonglongApp.filter("boxType",["diyData",function(diyData){return function(str){var temp;for(temp in diyData.boxType)if(str==diyData.boxType[temp].id)return diyData.boxType[temp].name}}]),yonglongApp.filter("orderType",["diyData",function(diyData){return function(str){var temp;for(temp in diyData.orderType)if(str==diyData.orderType[temp].id)return diyData.orderType[temp].name}}]),yonglongApp.filter("orderStatusText",function(){return function(input){var _bv="";switch(input){case 1:_bv="已审核";break;case 2:_bv="待装箱";break;case 3:_bv="已拼箱";break;case 8:_bv="已取消";break;case 9:_bv="完成";break;case 10:_bv="待提箱";break;case 11:_bv="待卸货";break;case 12:_bv="待装货";break;case 13:_bv="待进港";break;case 14:_bv="待落箱";break;case 20:_bv="待付款";break;case 21:_bv="已付款";break;case 22:_bv="部分支付";break;default:_bv="未审核";break;case 101:_bv="进行中"}return _bv}}),yonglongApp.controller("departCostListController",["$scope","interfaceService","rescode",function($scope,interfaceService,rescode){$scope.queryData={pageno:1,pagesize:10},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize},$scope.switchPage=function(page){$scope.queryData.pageno=page,httpList()};var httpList=function(){interfaceService.userDispatchList($scope.queryData,function(data,headers,config){console.log("response:"+JSON.stringify(data)),data.rescode==rescode.SUCCESS&&($scope.results=data.data)})};httpList()}]),yonglongApp.controller("userAllReportController",["$scope","$timeout","showDatePickerProvider","interfaceService","rescode",function($scope,$timeout,showDatePickerProvider,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.queryData={startTime:"",endTime:"",owner:!1,sender:""};var httpList=function(){interfaceService.reportList($scope.queryData,function(data,headers,config){console.log("response:"+JSON.stringify(data)),(data.rescode=rescode.SUCCESS)&&($scope.flist=data.data.flist,$scope.list=data.data.list)})};$scope.queryList=function($valid){$valid&&httpList()},httpList()}]),yonglongApp.controller("userCreateWithdrawController",["$scope","$timeout","$state","interfaceService","showDatePickerProvider","rescode",function($scope,$timeout,$state,interfaceService,showDatePickerProvider,rescode){showDatePickerProvider.showDatePicker(),$scope.cashListCheckbox=[],$scope.cashListDispatchCheckbox=[],$scope.params={bankNo:null,orderIds:"",refundMoney:0};var updateParams=function(){var temp;$scope.params.refundMoney=0,$scope.params.orderIds="";for(temp in $scope.cashListCheckbox)$scope.params.refundMoney+=$scope.cashListCheckbox[temp].moneyPaid,$scope.params.orderIds+=$scope.cashListCheckbox[temp].id+",";for(temp in $scope.cashListDispatchCheckbox)$scope.params.refundMoney+=$scope.cashListDispatchCheckbox[temp].moneyPaid+$scope.cashListDispatchCheckbox[temp].offerOrderPaid,$scope.params.orderIds+="-->"+$scope.cashListDispatchCheckbox[temp].id+","},getCashList=function(){interfaceService.cashList({},function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.cashList=data.data.listCash,$scope.listCashDispatch=data.data.dataDispatch)})},getListBankCard=function(){interfaceService.listBankCard({},function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.listBankCards=data.data),$timeout(getCashList,50)})};$scope.changeBankCard=function(){console.log("card!!!")},$scope.companyUserDetail=function(userId){var param={userId:userId};interfaceService.companyUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=1,$("#bus-user-detail-modal").modal("show"))})},$scope.isSelected=function(result){return $scope.cashListCheckbox.indexOf(result)>=0},$scope.isDispatchSelected=function(result){return $scope.cashListDispatchCheckbox.indexOf(result)>=0},$scope.updateCashListCBSelect=function($event,result){var checkbox=$event.target,checked=checkbox.checked;if(checked)$scope.cashListCheckbox.push(result);else{var idx=$scope.cashListCheckbox.indexOf(result);$scope.cashListCheckbox.splice(idx,1)}updateParams()},$scope.updateCashListDispatchCBSelect=function($event,result){var checkbox=$event.target,checked=checkbox.checked;if(checked)$scope.cashListDispatchCheckbox.push(result);else{var idx=$scope.cashListCheckbox.indexOf(result);$scope.cashListDispatchCheckbox.splice(idx,1)}updateParams()},$scope.onSubmit=function(){null==$scope.params.bankNo?swal({title:"请选择卡号?",text:"请选择提现的银行卡卡号!",type:"error",confirmButtonText:"好!",closeOnConfirm:!0}):0==$scope.params.refundMoney?swal({title:"请选择需要提现的订单?",text:"请选择需要提现的订单!",type:"error",confirmButtonText:"好!",closeOnConfirm:!0}):swal({title:"确定创建提现订单吗?",text:"您即将创建一份新提现的订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,创建!",closeOnConfirm:!1,showLoaderOnConfirm:!0,animation:"slide-from-top"},function(){interfaceService.addRefundApply($scope.params,function(data,headers,config){data.rescode==rescode.SUCCESS&&swal({title:"创建成功！",text:"已成功创建提现订单。",type:"success",showCancelButton:!0,cancelButtonText:"继续创建",confirmButtonText:"前往提现列表"},function(confirm){confirm?$state.go("main.companyinner.withdraw_list"):($scope.params={bankNo:null,orderIds:"",refundMoney:0},getListBankCard())})})})},getListBankCard()}]),yonglongApp.controller("userFriendManageController",["$scope","interfaceService","rescode",function($scope,interfaceService,rescode){$scope.queryData={pageno:1,pagesize:20},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize},$scope.busownerResults={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize};var httpList=function(){interfaceService.userListFriend($scope.queryData,function(data,headers,config){$scope.results=data.data})};$scope.switchPage=function(page){$scope.queryData.pageno=page,httpList()},$scope.updateState=function(id,type){var param={id:id,status:1},title="确定通过请求吗？",text="您即将通过这位好友的请求！",confirmButtonText="是的,通过!",successTitle="好友添加成功!",successText="已经成功通过好友的添加请求!",errorTitle="执行失败!";switch(type){case 0:break;case 1:param.status=9,title="确定拒绝请求吗？",text="您即将拒绝这位好友的请求！",confirmButtonText="是的,拒绝!",successTitle="好友拒绝成功!",successText="已经成功拒绝好友的添加请求!"}swal({title:title,text:text,type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:confirmButtonText,closeOnConfirm:!1,showLoaderOnConfirm:!0,animation:"slide-from-top"},function(){interfaceService.userEditFriend(param,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:successTitle,text:successText,type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:errorTitle,text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},httpList()}]),yonglongApp.controller("userHasgetOrderController",["$scope","$timeout","showDatePickerProvider","baseDataService","interfaceService","rescode",function($scope,$timeout,showDatePickerProvider,baseDataService,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.orderType=baseDataService.getOrderTypeN(),$scope.containerVType=baseDataService.getBoxVolN(),$scope.containerSType=baseDataService.getBoxTypeN(),$scope.queryData={orderSn:"",startTime:"",endTime:"",originPort:"",loadingPort:"",returnPort:"",orderType:"-1",containerVType:"-1",containerSType:"-1",goodsMemberName:"",busMemberName:"",pageno:1,pagesize:20},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize};var httpList=function(){interfaceService.userListMyorder($scope.queryData,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.results=data.data)})};$scope.queryList=function($valid){$valid&&httpList()},$scope.switchPage=function(page){$scope.queryData.pageno=page,httpList()},$scope.companyUserDetail=function(userId){var param={userId:userId};interfaceService.companyUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=1,$("#bus-user-detail-modal").modal("show"))})},$scope.over=function(orderId){swal({title:"确认送到吗?",text:"您即将确认送到此订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,确认!",closeOnConfirm:!1,showLoaderOnConfirm:!0},function(){var tempData={orderId:orderId};interfaceService.userOverOfferOrder(tempData,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"确认成功！",text:"此订单已确认送到。",type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:"确认失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},$scope.cancelOrder=function(orderId){swal({title:"确定取消吗?",text:"您即将取消这份订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,取消!",closeOnConfirm:!1,showLoaderOnConfirm:!0},function(){var tempData={orderId:orderId};interfaceService.cancelOrder(tempData,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"取消成功！",text:"此订单已取消。",type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:"取消失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},httpList()}]),yonglongApp.controller("userHasgetOrderController2",["$scope","$timeout","showDatePickerProvider","baseDataService","interfaceService","rescode",function($scope,$timeout,showDatePickerProvider,baseDataService,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.orderType=baseDataService.getOrderTypeN(),$scope.containerVType=baseDataService.getBoxVolN(),$scope.containerSType=baseDataService.getBoxTypeN(),$scope.queryData={orderSn:"",startTime:"",endTime:"",originPort:"",loadingPort:"",returnPort:"",orderType:"-1",containerVType:"-1",containerSType:"-1",goodsMemberName:"",busMemberName:"",pageno:1,pagesize:20},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize};var httpList=function(){interfaceService.userListDispatchorder($scope.queryData,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.results=data.data)})};$scope.queryList=function($valid){$valid&&httpList()},$scope.switchPage=function(page){$scope.queryData.pageno=page,httpList()},$scope.test=function(){console.log(321)},$scope.companyUserDetail=function(userId){console.log(123);var param={userId:userId};interfaceService.companyUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=1,$("#bus-user-detail-modal").modal("show"))})},$scope.over=function(orderId){swal({title:"确认送到吗?",text:"您即将确认送到此订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,确认!",closeOnConfirm:!1,showLoaderOnConfirm:!0},function(){var tempData={orderId:orderId};interfaceService.userOverOfferOrder(tempData,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"确认成功！",text:"此订单已确认送到。",type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:"确认失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},$scope.cancelOrder=function(orderId){swal({title:"确定取消吗?",text:"您即将取消这份订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,取消!",closeOnConfirm:!1,showLoaderOnConfirm:!0},function(){var tempData={orderId:orderId};interfaceService.cancelOrder(tempData,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"取消成功！",text:"此订单已取消。",type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:"取消失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},httpList()}]),yonglongApp.controller("userRegisterController",["$scope","$state","dropifyProvider","interfaceService","rescode","baseDataService",function($scope,$state,dropifyProvider,interfaceService,rescode,baseDataService){dropifyProvider.dropify(),$scope.showTerms=function(){$("#terms").modal("show")},$scope.containerVType=baseDataService.getBoxVol(),$scope.reg={memberName:"",password:"",passwordconfirm:"",companyName:"",companyLinker:"",email:"",mobilePhone:"",tel:"",licence:"",nameCard:"",nameCardBack:"",mobileCode:"",address:"",carNumber:"",busContainer:null},$scope.regfile1={name:"drivingLicence",file:""},$scope.regfile2={name:"roadLicence",file:""},$scope.regfile3={name:"roadLicenceAttach",file:""},$scope.regfile4={name:"carPic",file:""},$scope.regfile5={name:"nameCard",file:""};var files=[$scope.regfile5,$scope.regfile1,$scope.regfile2,$scope.regfile3,$scope.regfile4];$scope.onSubmit=function($valid){$valid?interfaceService.userRegister($scope.reg,files,function(data,headers,config){console.log(JSON.stringify(data)),data.rescode==rescode.SUCCESS?$state.go("main.userinner.wanner_order"):data.rescode==rescode.AGAIN_PHONE||data.rescode==rescode.EMPTY_SMS_CODE}):console.log("$valid:"+$valid)}}]),yonglongApp.controller("userUpdateInfoController",["$scope","$state","dropifyProvider","interfaceService","rescode","baseDataService",function($scope,$state,dropifyProvider,interfaceService,rescode,baseDataService){dropifyProvider.dropify(),$scope.showTerms=function(){$("#terms").modal("show")},$scope.containerVType=baseDataService.getBoxVol(),$scope.reg={memberName:"",password:"",passwordconfirm:"",companyName:"",companyLinker:"",email:"",mobilePhone:"",tel:"",licence:"",nameCard:"",nameCardBack:"",mobileCode:"",address:"",carNumber:"",busContainer:null},$scope.regfile1={name:"drivingLicence",file:""},$scope.regfile2={name:"roadLicence",file:""},$scope.regfile3={name:"roadLicenceAttach",file:""},$scope.regfile4={name:"carPic",file:""},$scope.regfile5={name:"nameCard",file:""};var files=[$scope.regfile5,$scope.regfile1,$scope.regfile2,$scope.regfile3,$scope.regfile4];$scope.onSubmit=function($valid){$valid?interfaceService.userUpdateInfo($scope.reg,files,function(data,headers,config){data.rescode==rescode.SUCCESS&&swal({title:"修改成功！",text:"已成功修改个人信息。",type:"success",confirmButtonText:"确定"},function(){})}):console.log("$valid:"+$valid)},$scope.getUserInfo=function(){interfaceService.userUserinfo({},function(data,headers,config){console.log(JSON.stringify(data)),$scope.reg=data.data})},$scope.getUserInfo()}]),yonglongApp.controller("userWannerOrderController",["$scope","$timeout","showDatePickerProvider","baseDataService","interfaceService","rescode",function($scope,$timeout,showDatePickerProvider,baseDataService,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.orderType=baseDataService.getOrderTypeN(),$scope.containerVType=baseDataService.getBoxVolN(),$scope.containerSType=baseDataService.getBoxTypeN(),$scope.queryData={orderSn:"",orderStatus:"",startTime:"",endTime:"",originPort:"",loadingPort:"",shippingDate:"",returnPort:"",orderType:"-1",containerVType:"-1",containerSType:"-1",goodsMemberName:"",busMemberName:"",pageno:1,pagesize:10},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize};var httpList=function(){interfaceService.userListGetorder($scope.queryData,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.results=data.data)})};$scope.queryList=function($valid){$valid&&httpList()},$scope.companyUserDetail=function(userId){var param={userId:userId};interfaceService.companyUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=1,$("#bus-user-detail-modal").modal("show"))})},$scope.takeOrder=function(orderId){swal({title:"确认接单吗?",text:"您即将接收此订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,接单!",closeOnConfirm:!1,showLoaderOnConfirm:!0},function(){var param={orderId:orderId};interfaceService.userTakeOfferOrder(param,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"接单成功！",text:"此订单已接收完毕。",type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:"接单失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},httpList()}]),yonglongApp.controller("userWithdrawListController",["$scope","interfaceService","rescode",function($scope,interfaceService,rescode){$scope.queryData={pageno:1,pagesize:10},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize};var httpList=function(){interfaceService.listRefundApply($scope.queryData,function(data,headers,config){$scope.results=data.data})};$scope.switchPage=function(page){$scope.queryData.pageno=page,httpList()},httpList()}]),yonglongApp.controller("userWithdrawManageController",["$scope","interfaceService","rescode",function($scope,interfaceService,rescode){$scope.params={bankCardNo:"",bankCardOwner:"",bankName:""};var httpList=function(){interfaceService.listBankCard({},function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.results=data.data,console.log($scope.results.dataList.length))})};$scope.del=function(result){swal({title:"确定删除吗?",text:"您即将删除"+result.bankCardOwner+"的账户!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,删除!",closeOnConfirm:!1,showLoaderOnConfirm:!0,animation:"slide-from-top"},function(){var param={id:result.id};interfaceService.delBankCard(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&swal({title:"删除成功成功！",text:"已成功删除此提现账户。",type:"success",confirmButtonText:"确定"},function(){httpList()})})})},$scope.showAddBankCard=function(){$("#add-bank-card").modal("show")},$scope.onSubmit=function($valid){$valid&&interfaceService.addBankCard($scope.params,function(data,headers,config){data.rescode==rescode.SUCCESS&&swal({title:"创建成功",text:"您已成功创建提现帐号!",type:"success",confirmButtonText:"完成",closeOnConfirm:!0},function(){$("#add-bank-card").modal("hide"),httpList()})})},httpList()}]),yonglongApp.controller("accountInfoController",["$scope","countupProvider","interfaceService","rescode",function($scope,countupProvider,interfaceService,rescode){$scope.result={all:0,canpos:0,pay:0,pos:0,posing:0};var refresh=function(){interfaceService.accountInfo({},function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.result=data.data)})};refresh()}]),yonglongApp.controller("createOrderController",["$scope","$timeout","$state","showDatePickerProvider","URL_CONS","baseDataService","interfaceService","rescode",function($scope,$timeout,$state,showDatePickerProvider,URL_CONS,baseDataService,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.orderType=baseDataService.getOrderType(),$scope.containerVType=baseDataService.getBoxVol(),$scope.containerSType=baseDataService.getBoxType(),$scope.orderDetail={shippingName:"辽宁号",shippingDate:"2016-12-31",originPort:"洋山深水港",loadingPort:"大连港",returnPort:"天津港",transitPort:"外高桥港",destPort:"珠海港",orderType:"0",containerVType:"0",containerSType:"0",containerVol:200,grossWeight:500,note:"",shippingFee:"34",extraFee:"245",referenceShippingFee:"34",shippingSn:"AXJIE8737492J"},$scope.onSubmit=function($valid){$valid&&swal({title:"确定创建订单吗?",text:"您即将创建一份新的订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,创建!",closeOnConfirm:!1,showLoaderOnConfirm:!0,animation:"slide-from-top"},function(){interfaceService.companyCreateOrder($scope.orderDetail,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"创建成功！",text:"已成功创建订单。",type:"success",showCancelButton:!0,cancelButtonText:"继续创建",confirmButtonText:"订单查询"},function(){$state.go("main.companyinner.query_order")}):swal({title:"创建失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},$scope.offlineOpts={retryInterval:5e3};var longitude=121.506191,latitude=31.245554;$scope.mapOptions={center:{longitude:longitude,latitude:latitude},zoom:17,city:"ShangHai",markers:[{longitude:longitude,latitude:latitude,icon:"img/mappiont.png",width:49,height:60,title:"Where",content:"Put description here"}]},$scope.mapLoaded=function(map){console.log(map)},$timeout(function(){$scope.mapOptions.center.longitude=121.500885,$scope.mapOptions.center.latitude=31.190032,$scope.mapOptions.markers[0].longitude=121.500885,$scope.mapOptions.markers[0].latitude=31.190032},5e3)}]),yonglongApp.controller("createWithdrawController",["$scope","$timeout","$state","interfaceService","showDatePickerProvider","rescode",function($scope,$timeout,$state,interfaceService,showDatePickerProvider,rescode){showDatePickerProvider.showDatePicker(),$scope.cashListCheckbox=[],$scope.cashListDispatchCheckbox=[],$scope.params={bankNo:null,orderIds:"",refundMoney:0};var updateParams=function(){var temp;$scope.params.refundMoney=0,$scope.params.orderIds="";for(temp in $scope.cashListCheckbox)$scope.params.refundMoney+=$scope.cashListCheckbox[temp].moneyPaid,$scope.params.orderIds+=$scope.cashListCheckbox[temp].id+",";for(temp in $scope.cashListDispatchCheckbox)$scope.params.refundMoney+=$scope.cashListDispatchCheckbox[temp].moneyPaid+$scope.cashListDispatchCheckbox[temp].offerOrderPaid,$scope.params.orderIds+="-->"+$scope.cashListDispatchCheckbox[temp].id+","},getCashList=function(){interfaceService.cashList({},function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.cashList=data.data.listCash,$scope.listCashDispatch=data.data.dataDispatch)})},getListBankCard=function(){interfaceService.listBankCard({},function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.listBankCards=data.data),$timeout(getCashList,50)})};$scope.changeBankCard=function(){console.log("card!!!")},$scope.companyUserDetail=function(userId){var param={userId:userId};interfaceService.companyUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=1,$("#bus-user-detail-modal").modal("show"))})},$scope.isSelected=function(result){return $scope.cashListCheckbox.indexOf(result)>=0},$scope.isDispatchSelected=function(result){return $scope.cashListDispatchCheckbox.indexOf(result)>=0},$scope.updateCashListCBSelect=function($event,result){var checkbox=$event.target,checked=checkbox.checked;if(checked)$scope.cashListCheckbox.push(result);else{var idx=$scope.cashListCheckbox.indexOf(result);$scope.cashListCheckbox.splice(idx,1)}updateParams()},$scope.updateCashListDispatchCBSelect=function($event,result){var checkbox=$event.target,checked=checkbox.checked;if(checked)$scope.cashListDispatchCheckbox.push(result);else{var idx=$scope.cashListCheckbox.indexOf(result);$scope.cashListDispatchCheckbox.splice(idx,1)}updateParams()},$scope.onSubmit=function(){null==$scope.params.bankNo?swal({title:"请选择卡号?",text:"请选择提现的银行卡卡号!",type:"error",confirmButtonText:"好!",closeOnConfirm:!0}):0==$scope.params.refundMoney?swal({title:"请选择需要提现的订单?",text:"请选择需要提现的订单!",type:"error",confirmButtonText:"好!",closeOnConfirm:!0}):swal({title:"确定创建提现订单吗?",text:"您即将创建一份新提现的订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,创建!",closeOnConfirm:!1,showLoaderOnConfirm:!0,animation:"slide-from-top"},function(){interfaceService.addRefundApply($scope.params,function(data,headers,config){data.rescode==rescode.SUCCESS&&swal({title:"创建成功！",text:"已成功创建提现订单。",type:"success",showCancelButton:!0,
cancelButtonText:"继续创建",confirmButtonText:"前往提现列表"},function(confirm){confirm?$state.go("main.companyinner.withdraw_list"):($scope.params={bankNo:null,orderIds:"",refundMoney:0},getListBankCard())})})})},getListBankCard()}]),yonglongApp.controller("friendManageController",["$scope","interfaceService","rescode",function($scope,interfaceService,rescode){$scope.queryData={startTime:"",endTime:"",orderType:"",pageno:1,pagesize:20},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize},$scope.busownerResults={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize},$scope.busowner={mobilePhone:""},$scope.addFriendId={busMemberId:""};var httpList=function(){interfaceService.companyListFriend($scope.queryData,function(data,headers,config){$scope.results=data.data})},httpBusowner=function(){interfaceService.companyListBusowners($scope.busowner,function(data,headers,config){$scope.busownerResults=data.data})};$scope.queryList=function($valid){$valid&&httpList()},$scope.switchPage=function(page){$scope.queryData.pageno=page,httpList()},$scope.getBusowner=function($valid){$valid&&httpBusowner()},$scope.addFriend=function(){""!=$scope.addFriendId.busMemberId&&interfaceService.companyAddFriend($scope.addFriendId,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"添加成功！",text:"已添加好友。",type:"success",confirmButtonText:"确定"},function(){httpBusowner(),httpList()}):swal({title:"添加失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})},$scope.delFriend=function(fid){swal({title:"确定解除关系吗?",text:"您即将解除与该好友的关系!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,解除!",closeOnConfirm:!1,showLoaderOnConfirm:!0,animation:"slide-from-top"},function(){var param={fid:fid};interfaceService.companyDelFriend(param,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"解除成功！",text:"已解除好友关系。",type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:"解除失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},httpList()}]),yonglongApp.controller("hasgetOrderController",["$scope","$timeout","showDatePickerProvider","baseDataService","interfaceService","rescode",function($scope,$timeout,showDatePickerProvider,baseDataService,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.orderType=baseDataService.getOrderTypeN(),$scope.containerVType=baseDataService.getBoxVolN(),$scope.containerSType=baseDataService.getBoxTypeN(),$scope.queryData={orderSn:"",startTime:"",endTime:"",originPort:"",loadingPort:"",returnPort:"",orderType:"-1",containerVType:"-1",containerSType:"-1",goodsMemberName:"",busMemberName:"",pageno:1,pagesize:20},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize};var httpList=function(){interfaceService.companyListMyorder($scope.queryData,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.results=data.data)})};$scope.queryList=function($valid){$valid&&httpList()},$scope.switchPage=function(page){$scope.queryData.pageno=page,httpList()},$scope.busUserDetail=function(userId,type){switch(type){case 0:param={userId:userId};break;case 1:param={orderId:userId}}interfaceService.busUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=0,$("#bus-user-detail-modal").modal("show"))})},$scope.companyUserDetail=function(userId){console.log("===> ");var param={userId:userId};interfaceService.companyUserDetail(param,function(data,headers,config){console.log("response:"+JSON.stringify(data)),data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=1,$("#bus-user-detail-modal").modal("show"))})},$scope.selectedOid=function(orderId){},$scope.cancelOrder=function(orderId){swal({title:"确定取消吗?",text:"您即将取消这份订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,取消!",closeOnConfirm:!1,showLoaderOnConfirm:!0},function(){var tempData={orderId:orderId};interfaceService.cancelOrder(tempData,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"取消成功！",text:"此订单已取消。",type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:"取消失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},httpList()}]),yonglongApp.controller("mainController",["$rootScope","$scope","$timeout",function($rootScope,$scope,$timeout){$rootScope.$on("$stateChangeStart",function(event,toState,toParams,fromState,fromParams){console.info(fromState+"->"+toState,toParams,fromParams)}),$timeout(function(){var uiState=new UiState;uiState.ready()},50)}]),yonglongApp.controller("queryOrderController",["$scope","showDatePickerProvider","baseDataService","interfaceService","rescode",function($scope,showDatePickerProvider,baseDataService,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.orderType=baseDataService.getOrderTypeN(),$scope.containerVType=baseDataService.getBoxVolN(),$scope.containerSType=baseDataService.getBoxTypeN(),$scope.queryData={goodsMemberId:67,startTime:"",endTime:"",orderSn:"",shippingDate:"",originPort:"",loadingPort:"",returnPort:"",orderType:"-1",containerVType:"-1",containerSType:"-1",goodsMemberName:"",busMemberName:"",pageno:1,pagesize:10},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize},$scope.switchPage=function(page){$scope.queryData.pageno=page,httpList()};var httpList=function(){interfaceService.companyOrderList($scope.queryData,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.results=data.data)})};$scope.queryList=function($valid){$valid&&httpList()},$scope.delete=function(orderId){swal({title:"确定删除吗?",text:"您即将删除这份订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,删除!",closeOnConfirm:!1,showLoaderOnConfirm:!0},function(){var tempData={orderId:orderId};interfaceService.deleteOrder(tempData,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"删除成功！",text:"此订单已删除。",type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:"删除失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},$scope.busUserDetail=function(userId,type){switch(type){case 0:param={userId:userId};break;case 1:param={orderId:userId}}interfaceService.busUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=0,$("#bus-user-detail-modal").modal("show"))})},$scope.companyUserDetail=function(userId){var param={userId:userId};interfaceService.companyUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=1,$("#bus-user-detail-modal").modal("show"))})},httpList()}]),yonglongApp.controller("receiveReportController",["$scope","$timeout","showDatePickerProvider","interfaceService","rescode",function($scope,$timeout,showDatePickerProvider,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.queryData={startTime:"",endTime:"",owner:!1,sender:""};var httpList=function(){interfaceService.reportList($scope.queryData,function(data,headers,config){(data.rescode=rescode.SUCCESS)&&($scope.flist=data.data.flist,$scope.list=data.data.list)})};$scope.queryList=function($valid){$valid&&httpList()},httpList()}]),yonglongApp.controller("registerCompanyController",["$scope","$state","dropifyProvider","interfaceService","rescode",function($scope,$state,dropifyProvider,interfaceService,rescode){dropifyProvider.dropify(),$scope.showTerms=function(){$("#terms").modal("show")},$scope.reg={memberName:"",password:"",passwordconfirm:"",companyName:"",companyLinker:"",email:"",mobilePhone:"",tel:"",licence:"",nameCard:"",nameCardBack:"",mobileCode:"",address:""},$scope.regfile1={name:"nameCardFile",file:""},$scope.regfile2={name:"nameCardBackFile",file:""},$scope.regfile3={name:"licenceFile",file:""};var files=[$scope.regfile1,$scope.regfile2,$scope.regfile3];$scope.onSubmit=function($valid){$valid?interfaceService.companyRegister($scope.reg,files,function(data,headers,config){console.log(JSON.stringify(data)),data.rescode==rescode.SUCCESS?$state.go("main.companyinner.create_order"):data.rescode==rescode.AGAIN_PHONE||data.rescode==rescode.EMPTY_SMS_CODE}):console.log("$valid:"+$valid)}}]),yonglongApp.controller("sendReportController",["$scope","$timeout","showDatePickerProvider","interfaceService","rescode",function($scope,$timeout,showDatePickerProvider,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.queryData={startTime:"",endTime:"",owner:!0,sender:""};var httpList=function(){interfaceService.reportList($scope.queryData,function(data,headers,config){(data.rescode=rescode.SUCCESS)&&($scope.flist=data.data.flist,$scope.list=data.data.list)})};$scope.queryList=function($valid){$valid&&httpList()},httpList()}]),yonglongApp.controller("updateInfoController",["$scope","dropifyProvider","interfaceService",function($scope,dropifyProvider,interfaceService){dropifyProvider.dropify(),$scope.reg={memberName:"",password:"",passwordconfirm:"",companyName:"",companyLinker:"",email:"",mobilePhone:"",tel:"",licence:"",nameCard:"",nameCardBack:"",mobileCode:"",address:""},$scope.regfile1={name:"nameCardFile",file:""},$scope.regfile2={name:"nameCardBackFile",file:""},$scope.regfile3={name:"licenceFile",file:""};var files=[$scope.regfile1,$scope.regfile2,$scope.regfile3];$scope.onSubmit=function($valid){$valid?interfaceService.companyUpdateinfo($scope.reg,files,function(data,headers,config){data.rescode==rescode.SUCCESS&&swal({title:"修改成功！",text:"已成功修改个人信息。",type:"success",confirmButtonText:"确定"},function(){})}):console.log("$valid:"+$valid)},$scope.getUserInfo=function(){interfaceService.companyUserinfo({},function(data,headers,config){console.log(JSON.stringify(data)),$scope.reg=data.data})},$scope.getUserInfo()}]),yonglongApp.controller("wannerOrderController",["$scope","$timeout","showDatePickerProvider","baseDataService","interfaceService","rescode",function($scope,$timeout,showDatePickerProvider,baseDataService,interfaceService,rescode){showDatePickerProvider.showDatePicker(),$scope.orderType=baseDataService.getOrderTypeN(),$scope.containerVType=baseDataService.getBoxVolN(),$scope.containerSType=baseDataService.getBoxTypeN(),$scope.queryData={orderSn:"",orderStatus:"",startTime:"",endTime:"",originPort:"",loadingPort:"",shippingDate:"",returnPort:"",orderType:"-1",containerVType:"-1",containerSType:"-1",goodsMemberName:"",busMemberName:"",pageno:1,pagesize:10},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize};var httpList=function(){interfaceService.companyListGetorder($scope.queryData,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.results=data.data)})};$scope.queryList=function($valid){$valid&&httpList()},$scope.companyUserDetail=function(userId){var param={userId:userId};interfaceService.companyUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=1,$("#bus-user-detail-modal").modal("show"))})},$scope.busUserDetail=function(userId){var param={orderId:userId};interfaceService.busUserDetail(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.busUserDetailResult=data.data,$scope.busUserDetailResult.resultType=0,$("#bus-user-detail-modal").modal("show"))})},$scope.takeOrder=function(orderId){swal({title:"确认接单吗?",text:"您即将接收此订单!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,接单!",closeOnConfirm:!1,showLoaderOnConfirm:!0},function(){var param={orderId:orderId,busMemberType:0};interfaceService.fleetTakeOfferOrder(param,function(data,headers,config){data.rescode==rescode.SUCCESS?swal({title:"接单成功！",text:"此订单已接收完毕。",type:"success",confirmButtonText:"确定"},function(){httpList()}):swal({title:"接单失败！",text:"请重新执行此操作。",type:"error",confirmButtonText:"确定"})})})},httpList()}]),yonglongApp.controller("withdrawListController",["$scope","interfaceService","rescode",function($scope,interfaceService,rescode){$scope.queryData={pageno:1,pagesize:10},$scope.results={currPageNum:1,totalPages:0,pageSize:$scope.queryData.pagesize};var httpList=function(){interfaceService.listRefundApply($scope.queryData,function(data,headers,config){$scope.results=data.data})};$scope.switchPage=function(page){$scope.queryData.pageno=page,httpList()},httpList()}]),yonglongApp.controller("withdrawManageController",["$scope","interfaceService","rescode",function($scope,interfaceService,rescode){$scope.params={bankCardNo:"",bankCardOwner:"",bankName:""};var httpList=function(){interfaceService.listBankCard({},function(data,headers,config){data.rescode==rescode.SUCCESS&&($scope.results=data.data,console.log($scope.results.dataList.length))})};$scope.del=function(result){swal({title:"确定删除吗?",text:"您即将删除"+result.bankCardOwner+"的账户!",type:"warning",showCancelButton:!0,cancelButtonText:"取消",confirmButtonColor:"#DD6B55",confirmButtonText:"是的,删除!",closeOnConfirm:!1,showLoaderOnConfirm:!0,animation:"slide-from-top"},function(){var param={id:result.id};interfaceService.delBankCard(param,function(data,headers,config){data.rescode==rescode.SUCCESS&&swal({title:"删除成功成功！",text:"已成功删除此提现账户。",type:"success",confirmButtonText:"确定"},function(){httpList()})})})},$scope.showAddBankCard=function(){$("#add-bank-card").modal("show")},$scope.onSubmit=function($valid){$valid&&interfaceService.addBankCard($scope.params,function(data,headers,config){data.rescode==rescode.SUCCESS&&swal({title:"创建成功",text:"您已成功创建提现帐号!",type:"success",confirmButtonText:"完成",closeOnConfirm:!0},function(){$("#add-bank-card").modal("hide"),httpList()})})},httpList()}]),yonglongApp.service("baseDataService",["diyData",function(diyData){this.getOrderType=function(){return diyData.orderType},this.getOrderTypeN=function(){return diyData.orderTypeN},this.getBoxVol=function(){return diyData.boxVol},this.getBoxType=function(){return diyData.boxType},this.getBoxVolN=function(){return diyData.boxVolN},this.getBoxTypeN=function(){return diyData.boxTypeN},this.getPayStatusText=function(value){return"0"==value?"未付款":"1"==value?"已付款":void 0}}]),yonglongApp.provider("countupProvider",function(){this.$get=function(){return{countup:function(){console.log("countup")}}}}),yonglongApp.provider("dropifyProvider",function(){this.$get=function(){return{dropify:function(){console.log("dropify");jQuery(".dropify").dropify({messages:{default:"拖拽图片或点击添加",replace:"拖拽图片或点击替换",remove:"删除",error:{fileSize:"文件不能大于{{ value }}",imageFormat:"文件格式不正确"}}})}}}}),yonglongApp.factory("httpService",["$http","$timeout","$q","URL_CONS",function($http,$timeout,$q,URL_CONS){var _httpDefaultOpts={method:"POST",url:"",params:{},data:{},cache:!1,limit:!0,timeout:"httpTimeout",timeoutTime:100,isErrMsg:!1,isErrMsgFn:null,checkCode:!0,before:function(){},end:function(){},error:function(){},success:function(data){},checkCodeError:function(code,errMsg,data){}},_httpTimeoutArray={httpTimeout:null},_isErrMsgFn=function(opts){angular.isFunction(opts.isErrMsgFn)?opts.isErrMsgFn():console.log("因为操作不能够及时响应，请稍后在试...")},_httpBefore=function(opts){angular.isFunction(opts.before)&&opts.before()},_httpEnd=function(opts){angular.isFunction(opts.end)&&opts.end(),opts.limit&&$timeout.cancel(_httpTimeoutArray[opts.timeout])},_responseError=function(data,opts){return checkCode(data,opts)},_httpMin=function(opts,deferred){_httpBefore(opts);var formData=new FormData;formData.append("json",JSON.stringify(opts.data.json)),opts.data.files&&angular.isArray(opts.data.files)&&angular.forEach(opts.data.files,function(file){formData.append(file.name,file.file)}),$http({method:opts.method,url:opts.url,params:opts.params,data:formData,headers:{"Content-Type":function(){}},transformRequest:angular.identity}).then(function(response){return!(opts.checkCode&&!_responseError(response.data,opts))&&(opts.success&&opts.success(response.data,response.config.headers,response.config,response.status),deferred&&deferred.resolve(response.data,response.config.headers,response.config,response.status),void _httpEnd(opts))}).catch(function(response){opts.isErrMsg&&_isErrMsgFn(),opts.error(response.data,response.config.headers,response.config,response.status),deferred&&deferred.reject(response.data,response.config.headers,response.config,response.status),_httpEnd(opts)})},_http=function(opts,deferred){opts=jQuery.extend({},_httpDefaultOpts,opts);var result;opts.limit?($timeout.cancel(_httpTimeoutArray[opts.timeout]),_httpTimeoutArray[opts.timeout]=$timeout(function(){result=_httpMin(opts,deferred)},opts.timeoutTime)):result=_httpMin(opts,deferred)},_linkHttpMin=function(opts,deferred){_http(opts,deferred)},checkCode=function(data,opts){return!0};return{http:function(opts){_http(opts)},linkHttp:function(opts,deferred){return deferred=deferred||$q.defer(),_linkHttpMin(opts,deferred),deferred.promise}}}]),yonglongApp.service("interfaceService",["httpService","URL_CONS","sessionService",function(httpService,URL_CONS,sessionService){this.doHttp=function(url,sub,params,success,error,files){var base={token:sessionService.getSession().token};jQuery.extend(params,sub),jQuery.extend(params,base);var request={json:params,files:files},_opts=jQuery.extend({timeout:"getError404Timeout"},null);_opts.url=url,_opts.method="POST",_opts.data=request,_opts.success=function(data,headers,config,status){success&&success(data,headers,config,status)},_opts.error=function(data,headers,config,status){error&&error(data,headers,config,status)},httpService.http(_opts)},this.doHttpMethod=function(method,params,success,error,files){var sub={method:method};files?this.doHttp(URL_CONS.serverFileUrl,sub,params,success,error,files):this.doHttp(URL_CONS.serverUrl,sub,params,success,error)},this.companyCreateOrder=function(params,success,error){var sub={method:URL_CONS.companyCreateOrder,orderStatus:1,orderCreditRank:5};this.doHttp(URL_CONS.serverUrl,sub,params,success,error)},this.companyOrderList=function(params,success,error){this.doHttpMethod(URL_CONS.companyOrderList,params,success,error)},this.deleteOrder=function(params,success,error){this.doHttpMethod(URL_CONS.deleteOrder,params,success,error)},this.companyListGetorder=function(params,success,error){this.doHttpMethod(URL_CONS.companyListGetorder,params,success,error)},this.companyListMyorder=function(params,success,error){this.doHttpMethod(URL_CONS.companyListMyorder,params,success,error)},this.companyRegister=function(params,files,success,error){this.doHttpMethod(URL_CONS.companyRegister,params,success,error,files)},this.companyUserinfo=function(params,success,error){this.doHttpMethod(URL_CONS.companyUserinfo,params,success,error)},this.companyUpdateinfo=function(params,files,success,error){this.doHttpMethod(URL_CONS.companyUpdateinfo,params,success,error,files)},this.companyUserDetail=function(params,success,error){this.doHttpMethod(URL_CONS.companyUserDetail,params,success,error)},this.busUserDetail=function(params,success,error){this.doHttpMethod(URL_CONS.busUserDetail,params,success,error)},this.fleetTakeOfferOrder=function(params,success,error){this.doHttpMethod(URL_CONS.fleetTakeOfferOrder,params,success,error)},this.cancelOrder=function(params,success,error){this.doHttpMethod(URL_CONS.cancelOrder,params,success,error)},this.companyListFriend=function(params,success,error){this.doHttpMethod(URL_CONS.companyListFriend,params,success,error)},this.companyListBusowners=function(params,success,error){this.doHttpMethod(URL_CONS.companyListBusowners,params,success,error)},this.companyAddFriend=function(params,success,error){this.doHttpMethod(URL_CONS.companyAddFriend,params,success,error)},this.companyDelFriend=function(params,success,error){this.doHttpMethod(URL_CONS.companyDelFriend,params,success,error)},this.accountInfo=function(params,success,error){this.doHttpMethod(URL_CONS.accountInfo,params,success,error)},this.addBankCard=function(params,success,error){this.doHttpMethod(URL_CONS.addBankCard,params,success,error)},this.listBankCard=function(params,success,error){this.doHttpMethod(URL_CONS.listBankCard,params,success,error)},this.delBankCard=function(params,success,error){this.doHttpMethod(URL_CONS.delBankCard,params,success,error)},this.listRefundApply=function(params,success,error){this.doHttpMethod(URL_CONS.listRefundApply,params,success,error)},this.addRefundApply=function(params,success,error){this.doHttpMethod(URL_CONS.addRefundApply,params,success,error)},this.cashList=function(params,success,error){this.doHttpMethod(URL_CONS.cashList,params,success,error)},this.reportList=function(params,success,error){this.doHttpMethod(URL_CONS.reportList,params,success,error)},this.userListGetorder=function(params,success,error){this.doHttpMethod(URL_CONS.userListGetorder,params,success,error)},this.userListMyorder=function(params,success,error){this.doHttpMethod(URL_CONS.userListMyorder,params,success,error)},this.userListDispatchorder=function(params,success,error){this.doHttpMethod(URL_CONS.userListDispatchorder,params,success,error)},this.userRegister=function(params,files,success,error){this.doHttpMethod(URL_CONS.userRegister,params,success,error,files)},this.userUserinfo=function(params,success,error){this.doHttpMethod(URL_CONS.userUserinfo,params,success,error)},this.userUpdateInfo=function(params,files,success,error){this.doHttpMethod(URL_CONS.userUpdateInfo,params,success,error,files)},this.userTakeOfferOrder=function(params,success,error){this.doHttpMethod(URL_CONS.userTakeOfferOrder,params,success,error)},this.userOverOfferOrder=function(params,success,error){this.doHttpMethod(URL_CONS.userOverOfferOrder,params,success,error)},this.userListFriend=function(params,success,error){this.doHttpMethod(URL_CONS.userListFriend,params,success,error)},this.userEditFriend=function(params,success,error){this.doHttpMethod(URL_CONS.userEditFriend,params,success,error)},this.userDispatchList=function(params,success,error){this.doHttpMethod(URL_CONS.userDispatchList,params,success,error)}}]),yonglongApp.service("sessionService",function(){this.getSession=function(){console.log("show token:"+eluser.token);var session={token:eluser.token};return session}}),yonglongApp.provider("showDatePickerProvider",function(){this.$get=function(){return{showDatePicker:function(){jQuery(".mydatepicker").datepicker({language:"zh-CN",autoclose:!0,format:"yyyy-mm-dd",todayHighlight:!0})}}}}),yonglongApp.directive("creditRank",function(){return{restrict:"A",replace:!0,scope:{star:"@forStar"},template:'<div style="overflow:hidden;width:{{star * 16}}px;"><img src="images/stars.png"></div>'}}),yonglongApp.directive("ngFilesModel",[function(){return{scope:{ngFilesModel:"="},link:function(scope,element,attributes){element.bind("change",function(changeEvent){scope.$apply(function(){scope.ngFilesModel=changeEvent.target.files[0]})})}}}]),yonglongApp.directive("orderdetail",function(){return{restrict:"A",replace:!0,templateUrl:"template/directive/order_detail.html"}}),yonglongApp.directive("pagination",function(){return{restrict:"AE",replace:!0,scope:{pageSize:"=",totalPages:"=",currPage:"=",showCount:"=",switchPage:"="},templateUrl:"template/directive/pagination.html",controller:function($scope){var changeData=function(){$scope.pageArray=[];var firstPage={pageNum:1,isCurrent:1==$scope.currPage,canClick:1!=$scope.currPage};if($scope.pageArray.push(firstPage),$scope.showCount>=$scope.totalPages)for(var i=2;i<$scope.totalPages;i++){var item={pageNum:i,isCurrent:$scope.currPage==i,canClick:$scope.currPage!=i};$scope.pageArray.push(item)}if(1!=$scope.totalPages){var lastPage={pageNum:$scope.totalPages,isCurrent:$scope.currPage==$scope.totalPages,canClick:$scope.currPage!=$scope.totalPages};$scope.pageArray.push(lastPage)}};$scope.$watch("totalPages",changeData,!0),$scope.$watch("currPage",changeData,!0)}}}),yonglongApp.directive("terms",function(){return{restrict:"AE",replace:!0,templateUrl:"template/directive/terms.html"}}),yonglongApp.config(["$stateProvider","$urlRouterProvider",function($stateProvider,$urlRouterProvider){$urlRouterProvider.when("","/main/userinner/wanner_order").otherwise("/main/userinner/wanner_order"),$stateProvider.state("login",{url:"/login",templateUrl:"template/login.html"}).state("register_company",{url:"/register_company",templateUrl:"template/register_company.html",controller:"registerCompanyController"}).state("register_user",{url:"/register_user",templateUrl:"template/register_user.html",controller:"userRegisterController"}).state("main",{url:"/main",templateUrl:"template/main.html"}),$stateProvider.state("main.userinner",{url:"/userinner",views:{nav:{templateUrl:"template/nav.html"},sidebar:{templateUrl:"template/sidebar_userinner.html",controller:"mainController"},footer:{templateUrl:"template/footer.html"}}}).state("main.userinner.wanner_order",{url:"/wanner_order",views:{"content@main":{templateUrl:"template/userinner/wanner_order.html",controller:"userWannerOrderController"}}}).state("main.userinner.hasget_order",{url:"/hasget_order",views:{"content@main":{templateUrl:"template/userinner/hasget_order.html",controller:"userHasgetOrderController"}}}).state("main.userinner.hasget2_order",{url:"/hasget2_order",views:{"content@main":{templateUrl:"template/userinner/hasget2_order.html",controller:"userHasgetOrderController2"}}}).state("main.userinner.all_report",{url:"/all_report",views:{"content@main":{templateUrl:"template/userinner/all_report.html",controller:"userAllReportController"}}}).state("main.userinner.friend_manage",{url:"/friend_manage",views:{"content@main":{templateUrl:"template/userinner/friend_manage.html",controller:"userFriendManageController"}}}).state("main.userinner.update_info",{url:"/update_info",views:{"content@main":{templateUrl:"template/userinner/update_info.html",controller:"userUpdateInfoController"}}}).state("main.userinner.depart_cost_list",{url:"/depart_cost_list",views:{"content@main":{templateUrl:"template/userinner/depart_cost_list.html",controller:"departCostListController"}}}).state("main.userinner.account_info",{url:"/account_info",views:{"content@main":{templateUrl:"template/companyinner/account_info.html",controller:"accountInfoController"}}}).state("main.userinner.withdraw_manage",{url:"/withdraw_manage",views:{"content@main":{templateUrl:"template/userinner/withdraw_manage.html",controller:"userWithdrawManageController"}}}).state("main.userinner.withdraw_list",{url:"/withdraw_list",views:{"content@main":{templateUrl:"template/userinner/withdraw_list.html",controller:"userWithdrawListController"}}}).state("main.userinner.create_withdraw",{url:"/create_withdraw",views:{"content@main":{templateUrl:"template/userinner/create_withdraw.html",controller:"userCreateWithdrawController"}}}),$stateProvider.state("main.companyinner",{url:"/companyinner",views:{nav:{templateUrl:"template/nav.html"},sidebar:{templateUrl:"template/sidebar_companyinner.html",controller:"mainController"},footer:{templateUrl:"template/footer.html"}}}).state("main.companyinner.create_order",{url:"/create_order",views:{"content@main":{templateUrl:"template/companyinner/create_order.html",controller:"createOrderController"}}}).state("main.companyinner.query_order",{url:"/query_order",views:{"content@main":{templateUrl:"template/companyinner/query_order.html",controller:"queryOrderController"}}}).state("main.companyinner.wanner_order",{url:"/wanner_order",views:{"content@main":{templateUrl:"template/companyinner/wanner_order.html",controller:"wannerOrderController"}}}).state("main.companyinner.hasget_order",{url:"/hasget_order",views:{"content@main":{templateUrl:"template/companyinner/hasget_order.html",controller:"hasgetOrderController"}}}).state("main.companyinner.send_report",{url:"/send_report",views:{"content@main":{templateUrl:"template/companyinner/send_report.html",controller:"sendReportController"}}}).state("main.companyinner.receive_report",{url:"/receive_report",views:{"content@main":{templateUrl:"template/companyinner/receive_report.html",controller:"receiveReportController"}}}).state("main.companyinner.friend_manage",{url:"/friend_manage",views:{"content@main":{templateUrl:"template/companyinner/friend_manage.html",controller:"friendManageController"}}}).state("main.companyinner.update_info",{url:"/update_info",views:{"content@main":{templateUrl:"template/companyinner/update_info.html",controller:"updateInfoController"}}}).state("main.companyinner.account_info",{url:"/account_info",views:{"content@main":{templateUrl:"template/companyinner/account_info.html",controller:"accountInfoController"}}}).state("main.companyinner.withdraw_manage",{url:"/withdraw_manage",views:{"content@main":{templateUrl:"template/companyinner/withdraw_manage.html",controller:"withdrawManageController"}}}).state("main.companyinner.create_withdraw",{url:"/create_withdraw",views:{"content@main":{templateUrl:"template/companyinner/create_withdraw.html",controller:"createWithdrawController"}}}).state("main.companyinner.withdraw_list",{url:"/withdraw_list",views:{"content@main":{templateUrl:"template/companyinner/withdraw_list.html",controller:"withdrawListController"}}})}])}).call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./utils/UiState":2,"./utils/bootstrap-datepicker":3,"./utils/jquery.counterup.min":4,"./utils/jquery.waypoints.min":5,angular:9,"angular-baidu-map":6,"angular-ui-router":7,bootstrap:11,"bootstrap-datepicker":10,dropify:24,jquery:27,"jquery-slimscroll":25,"jquery-toast-plugin":26,metismenu:28,sweetalert:37}],2:[function(require,module,exports){var UiState=function(){};UiState.prototype.ready=function(){$("#side-menu").metisMenu(),$(".right-side-toggle").click(function(){$(".right-sidebar").slideDown(50),$(".right-sidebar").toggleClass("shw-rside"),$(".fxhdr").click(function(){$("body").toggleClass("fix-header")}),$(".fxsdr").click(function(){$("body").toggleClass("fix-sidebar")}),$("body").hasClass("fix-header")?$(".fxhdr").attr("checked",!0):$(".fxhdr").attr("checked",!1),$("body").hasClass("fix-sidebar")?$(".fxsdr").attr("checked",!0):$(".fxsdr").attr("checked",!1)}),$(function(){$(window).bind("load resize",function(){topOffset=60,width=this.window.innerWidth>0?this.window.innerWidth:this.screen.width,width<768?($("div.navbar-collapse").addClass("collapse"),topOffset=100):$("div.navbar-collapse").removeClass("collapse"),height=(this.window.innerHeight>0?this.window.innerHeight:this.screen.height)-1,height-=topOffset,height<1&&(height=1),height>topOffset&&$("#page-wrapper").css("min-height",height+"px")});var url=window.location,element=$("ul.nav a").filter(function(){return this.href==url||0==url.href.indexOf(this.href)}).addClass("active").parent().parent().addClass("in").parent();element.is("li")&&element.addClass("active")}),$(function(){$(window).bind("load resize",function(){width=this.window.innerWidth>0?this.window.innerWidth:this.screen.width,width<1170?($("body").addClass("content-wrapper"),$(".open-close i").removeClass("icon-arrow-left-circle"),$(".sidebar-nav, .slimScrollDiv").css("overflow-x","visible").parent().css("overflow","visible"),$(".logo span").hide()):($("body").removeClass("content-wrapper"),$(".open-close i").addClass("icon-arrow-left-circle"),$(".logo span").show())})}),$(".open-close").on("click",function(){$("body").hasClass("content-wrapper")?($("body").trigger("resize"),$(".sidebar-nav, .slimScrollDiv").css("overflow","hidden").parent().css("overflow","visible"),$("body").removeClass("content-wrapper"),$(".open-close i").addClass("icon-arrow-left-circle"),$(".logo span").show()):($("body").trigger("resize"),$(".sidebar-nav, .slimScrollDiv").css("overflow-x","visible").parent().css("overflow","visible"),$("body").addClass("content-wrapper"),$(".open-close i").removeClass("icon-arrow-left-circle"),$(".logo span").hide());
}),function($,window,document){var panelSelector='[data-perform="panel-collapse"]';$(panelSelector).each(function(){var $this=$(this),parent=$this.closest(".panel"),wrapper=parent.find(".panel-wrapper"),collapseOpts={toggle:!1};wrapper.length||(wrapper=parent.children(".panel-heading").nextAll().wrapAll("<div/>").parent().addClass("panel-wrapper"),collapseOpts={}),wrapper.collapse(collapseOpts).on("hide.bs.collapse",function(){$this.children("i").removeClass("ti-minus").addClass("ti-plus")}).on("show.bs.collapse",function(){$this.children("i").removeClass("ti-plus").addClass("ti-minus")})}),$(document).on("click",panelSelector,function(e){e.preventDefault();var parent=$(this).closest(".panel"),wrapper=parent.find(".panel-wrapper");wrapper.collapse("toggle")})}(jQuery,window,document),function($,window,document){var panelSelector='[data-perform="panel-dismiss"]';$(document).on("click",panelSelector,function(e){function removeElement(){var col=parent.parent();parent.remove(),col.filter(function(){var el=$(this);return el.is('[class*="col-"]')&&0===el.children("*").length}).remove()}e.preventDefault();var parent=$(this).closest(".panel");removeElement()})}(jQuery,window,document),$(function(){$('[data-toggle="tooltip"]').tooltip()}),$(function(){$('[data-toggle="popover"]').popover()}),$(".list-task li label").click(function(){$(this).toggleClass("task-done")}),$(".settings_box a").click(function(){$("ul.theme_color").toggleClass("theme_block")}),$(".collapseble").click(function(){$(".collapseblebox").fadeToggle(350)});try{$(".slimscrollright").slimScroll({height:"100%",position:"right",size:"5px",color:"#dcdcdc"}),$(".slimscrollsidebar").slimScroll({height:"100%",position:"right",size:"0px",color:"#dcdcdc"}),$(".chat-list").slimScroll({height:"100%",position:"right",size:"0px",color:"#dcdcdc"})}catch(e){}$("body").trigger("resize"),$(".visited li a").click(function(e){$(".visited li").removeClass("active");var $parent=$(this).parent();$parent.hasClass("active")||$parent.addClass("active"),e.preventDefault()}),$("#to-recover").click(function(){$("#loginform").slideUp(),$("#recoverform").fadeIn()}),$(".navbar-toggle").click(function(){$(".navbar-toggle i").toggleClass("ti-menu"),$(".navbar-toggle i").addClass("ti-close")})},module.exports=UiState},{}],3:[function(require,module,exports){!function(a){a.fn.datepicker.dates["zh-CN"]={days:["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],daysShort:["周日","周一","周二","周三","周四","周五","周六"],daysMin:["日","一","二","三","四","五","六"],months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],monthsShort:["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],today:"今日",clear:"清除",format:"yyyy年mm月dd日",titleFormat:"yyyy年mm月",weekStart:1}}(jQuery)},{}],4:[function(require,module,exports){!function($){"use strict";$.fn.counterUp=function(options){var s,settings=$.extend({time:400,delay:10,formatter:!1,callback:function(){}},options);return this.each(function(){var $this=$(this),counter={time:$(this).data("counterup-time")||settings.time,delay:$(this).data("counterup-delay")||settings.delay},counterUpper=function(){var nums=[],divisions=counter.time/counter.delay,num=$this.text(),isComma=/[0-9]+,[0-9]+/.test(num);num=num.replace(/,/g,"");var decimalPlaces=(num.split(".")[1]||[]).length,isTime=/[0-9]+:[0-9]+:[0-9]+/.test(num);if(isTime){var times=num.split(":"),m=1;for(s=0;times.length>0;)s+=m*parseInt(times.pop(),10),m*=60}for(var i=divisions;i>=1;i--){var newNum=parseFloat(num/divisions*i).toFixed(decimalPlaces);if(isTime){newNum=parseInt(s/divisions*i);var hours=parseInt(newNum/3600)%24,minutes=parseInt(newNum/60)%60,seconds=parseInt(newNum%60,10);newNum=(hours<10?"0"+hours:hours)+":"+(minutes<10?"0"+minutes:minutes)+":"+(seconds<10?"0"+seconds:seconds)}if(isComma)for(;/(\d+)(\d{3})/.test(newNum.toString());)newNum=newNum.toString().replace(/(\d+)(\d{3})/,"$1,$2");settings.formatter&&(newNum=settings.formatter.call(this,newNum)),nums.unshift(newNum)}$this.data("counterup-nums",nums),$this.text("0");var f=function(){return $this.data("counterup-nums")?($this.html($this.data("counterup-nums").shift()),void($this.data("counterup-nums").length?setTimeout($this.data("counterup-func"),counter.delay):($this.data("counterup-nums",null),$this.data("counterup-func",null),settings.callback.call(this)))):void settings.callback.call(this)};$this.data("counterup-func",f),setTimeout($this.data("counterup-func"),counter.delay)};$this.waypoint(function(direction){counterUpper(),this.destroy()},{offset:"100%"})})}}(jQuery)},{}],5:[function(require,module,exports){!function(){"use strict";function t(o){if(!o)throw new Error("No options passed to Waypoint constructor");if(!o.element)throw new Error("No element option passed to Waypoint constructor");if(!o.handler)throw new Error("No handler option passed to Waypoint constructor");this.key="waypoint-"+e,this.options=t.Adapter.extend({},t.defaults,o),this.element=this.options.element,this.adapter=new t.Adapter(this.element),this.callback=o.handler,this.axis=this.options.horizontal?"horizontal":"vertical",this.enabled=this.options.enabled,this.triggerPoint=null,this.group=t.Group.findOrCreate({name:this.options.group,axis:this.axis}),this.context=t.Context.findOrCreateByElement(this.options.context),t.offsetAliases[this.options.offset]&&(this.options.offset=t.offsetAliases[this.options.offset]),this.group.add(this),this.context.add(this),i[this.key]=this,e+=1}var e=0,i={};t.prototype.queueTrigger=function(t){this.group.queueTrigger(this,t)},t.prototype.trigger=function(t){this.enabled&&this.callback&&this.callback.apply(this,t)},t.prototype.destroy=function(){this.context.remove(this),this.group.remove(this),delete i[this.key]},t.prototype.disable=function(){return this.enabled=!1,this},t.prototype.enable=function(){return this.context.refresh(),this.enabled=!0,this},t.prototype.next=function(){return this.group.next(this)},t.prototype.previous=function(){return this.group.previous(this)},t.invokeAll=function(t){var e=[];for(var o in i)e.push(i[o]);for(var n=0,r=e.length;r>n;n++)e[n][t]()},t.destroyAll=function(){t.invokeAll("destroy")},t.disableAll=function(){t.invokeAll("disable")},t.enableAll=function(){t.invokeAll("enable")},t.refreshAll=function(){t.Context.refreshAll()},t.viewportHeight=function(){return window.innerHeight||document.documentElement.clientHeight},t.viewportWidth=function(){return document.documentElement.clientWidth},t.adapters=[],t.defaults={context:window,continuous:!0,enabled:!0,group:"default",horizontal:!1,offset:0},t.offsetAliases={"bottom-in-view":function(){return this.context.innerHeight()-this.adapter.outerHeight()},"right-in-view":function(){return this.context.innerWidth()-this.adapter.outerWidth()}},window.Waypoint=t}(),function(){"use strict";function t(t){window.setTimeout(t,1e3/60)}function e(t){this.element=t,this.Adapter=n.Adapter,this.adapter=new this.Adapter(t),this.key="waypoint-context-"+i,this.didScroll=!1,this.didResize=!1,this.oldScroll={x:this.adapter.scrollLeft(),y:this.adapter.scrollTop()},this.waypoints={vertical:{},horizontal:{}},t.waypointContextKey=this.key,o[t.waypointContextKey]=this,i+=1,this.createThrottledScrollHandler(),this.createThrottledResizeHandler()}var i=0,o={},n=window.Waypoint,r=window.onload;e.prototype.add=function(t){var e=t.options.horizontal?"horizontal":"vertical";this.waypoints[e][t.key]=t,this.refresh()},e.prototype.checkEmpty=function(){var t=this.Adapter.isEmptyObject(this.waypoints.horizontal),e=this.Adapter.isEmptyObject(this.waypoints.vertical);t&&e&&(this.adapter.off(".waypoints"),delete o[this.key])},e.prototype.createThrottledResizeHandler=function(){function t(){e.handleResize(),e.didResize=!1}var e=this;this.adapter.on("resize.waypoints",function(){e.didResize||(e.didResize=!0,n.requestAnimationFrame(t))})},e.prototype.createThrottledScrollHandler=function(){function t(){e.handleScroll(),e.didScroll=!1}var e=this;this.adapter.on("scroll.waypoints",function(){(!e.didScroll||n.isTouch)&&(e.didScroll=!0,n.requestAnimationFrame(t))})},e.prototype.handleResize=function(){n.Context.refreshAll()},e.prototype.handleScroll=function(){var t={},e={horizontal:{newScroll:this.adapter.scrollLeft(),oldScroll:this.oldScroll.x,forward:"right",backward:"left"},vertical:{newScroll:this.adapter.scrollTop(),oldScroll:this.oldScroll.y,forward:"down",backward:"up"}};for(var i in e){var o=e[i],n=o.newScroll>o.oldScroll,r=n?o.forward:o.backward;for(var s in this.waypoints[i]){var a=this.waypoints[i][s],l=o.oldScroll<a.triggerPoint,h=o.newScroll>=a.triggerPoint,p=l&&h,u=!l&&!h;(p||u)&&(a.queueTrigger(r),t[a.group.id]=a.group)}}for(var c in t)t[c].flushTriggers();this.oldScroll={x:e.horizontal.newScroll,y:e.vertical.newScroll}},e.prototype.innerHeight=function(){return this.element==this.element.window?n.viewportHeight():this.adapter.innerHeight()},e.prototype.remove=function(t){delete this.waypoints[t.axis][t.key],this.checkEmpty()},e.prototype.innerWidth=function(){return this.element==this.element.window?n.viewportWidth():this.adapter.innerWidth()},e.prototype.destroy=function(){var t=[];for(var e in this.waypoints)for(var i in this.waypoints[e])t.push(this.waypoints[e][i]);for(var o=0,n=t.length;n>o;o++)t[o].destroy()},e.prototype.refresh=function(){var t,e=this.element==this.element.window,i=this.adapter.offset(),o={};this.handleScroll(),t={horizontal:{contextOffset:e?0:i.left,contextScroll:e?0:this.oldScroll.x,contextDimension:this.innerWidth(),oldScroll:this.oldScroll.x,forward:"right",backward:"left",offsetProp:"left"},vertical:{contextOffset:e?0:i.top,contextScroll:e?0:this.oldScroll.y,contextDimension:this.innerHeight(),oldScroll:this.oldScroll.y,forward:"down",backward:"up",offsetProp:"top"}};for(var n in t){var r=t[n];for(var s in this.waypoints[n]){var a,l,h,p,u,c=this.waypoints[n][s],d=c.options.offset,f=c.triggerPoint,w=0,y=null==f;c.element!==c.element.window&&(w=c.adapter.offset()[r.offsetProp]),"function"==typeof d?d=d.apply(c):"string"==typeof d&&(d=parseFloat(d),c.options.offset.indexOf("%")>-1&&(d=Math.ceil(r.contextDimension*d/100))),a=r.contextScroll-r.contextOffset,c.triggerPoint=w+a-d,l=f<r.oldScroll,h=c.triggerPoint>=r.oldScroll,p=l&&h,u=!l&&!h,!y&&p?(c.queueTrigger(r.backward),o[c.group.id]=c.group):!y&&u?(c.queueTrigger(r.forward),o[c.group.id]=c.group):y&&r.oldScroll>=c.triggerPoint&&(c.queueTrigger(r.forward),o[c.group.id]=c.group)}}for(var g in o)o[g].flushTriggers();return this},e.findOrCreateByElement=function(t){return e.findByElement(t)||new e(t)},e.refreshAll=function(){for(var t in o)o[t].refresh()},e.findByElement=function(t){return o[t.waypointContextKey]},window.onload=function(){r&&r(),e.refreshAll()},n.requestAnimationFrame=function(e){var i=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||t;i.call(window,e)},n.Context=e}(),function(){"use strict";function t(t,e){return t.triggerPoint-e.triggerPoint}function e(t,e){return e.triggerPoint-t.triggerPoint}function i(t){this.name=t.name,this.axis=t.axis,this.id=this.name+"-"+this.axis,this.waypoints=[],this.clearTriggerQueues(),o[this.axis][this.name]=this}var o={vertical:{},horizontal:{}},n=window.Waypoint;i.prototype.add=function(t){this.waypoints.push(t)},i.prototype.clearTriggerQueues=function(){this.triggerQueues={up:[],down:[],left:[],right:[]}},i.prototype.flushTriggers=function(){for(var i in this.triggerQueues){var o=this.triggerQueues[i],n="up"===i||"left"===i;o.sort(n?e:t);for(var r=0,s=o.length;s>r;r+=1){var a=o[r];(a.options.continuous||r===o.length-1)&&a.trigger([i])}}this.clearTriggerQueues()},i.prototype.next=function(e){this.waypoints.sort(t);var i=n.Adapter.inArray(e,this.waypoints),o=i===this.waypoints.length-1;return o?null:this.waypoints[i+1]},i.prototype.previous=function(e){this.waypoints.sort(t);var i=n.Adapter.inArray(e,this.waypoints);return i?this.waypoints[i-1]:null},i.prototype.queueTrigger=function(t,e){this.triggerQueues[e].push(t)},i.prototype.remove=function(t){var e=n.Adapter.inArray(t,this.waypoints);e>-1&&this.waypoints.splice(e,1)},i.prototype.first=function(){return this.waypoints[0]},i.prototype.last=function(){return this.waypoints[this.waypoints.length-1]},i.findOrCreate=function(t){return o[t.axis][t.name]||new i(t)},n.Group=i}(),function(){"use strict";function t(t){this.$element=e(t)}var e=window.jQuery,i=window.Waypoint;e.each(["innerHeight","innerWidth","off","offset","on","outerHeight","outerWidth","scrollLeft","scrollTop"],function(e,i){t.prototype[i]=function(){var t=Array.prototype.slice.call(arguments);return this.$element[i].apply(this.$element,t)}}),e.each(["extend","inArray","isEmptyObject"],function(i,o){t[o]=e[o]}),i.adapters.push({name:"jquery",Adapter:t}),i.Adapter=t}(),function(){"use strict";function t(t){return function(){var i=[],o=arguments[0];return t.isFunction(arguments[0])&&(o=t.extend({},arguments[1]),o.handler=arguments[0]),this.each(function(){var n=t.extend({},o,{element:this});"string"==typeof n.context&&(n.context=t(this).closest(n.context)[0]),i.push(new e(n))}),i}}var e=window.Waypoint;window.jQuery&&(window.jQuery.fn.waypoint=t(window.jQuery)),window.Zepto&&(window.Zepto.fn.waypoint=t(window.Zepto))}()},{}],6:[function(require,module,exports){!function(root,factory){if("object"==typeof exports&&"object"==typeof module)module.exports=factory(require("angular"));else if("function"==typeof define&&define.amd)define(["angular"],factory);else{var a=factory("object"==typeof exports?require("angular"):root.angular);for(var i in a)("object"==typeof exports?exports:root)[i]=a[i]}}(this,function(__WEBPACK_EXTERNAL_MODULE_1__){return function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="",__webpack_require__(0)}([function(module,exports,__webpack_require__){"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.ngBaiduMap=void 0;var _angular=__webpack_require__(1),_angular2=_interopRequireDefault(_angular),_defaults=__webpack_require__(2),_validator=__webpack_require__(3),_directiveDef=__webpack_require__(4),_baiduScriptLoader=__webpack_require__(5),_offline=__webpack_require__(6),_map=__webpack_require__(7);exports.ngBaiduMap=function(){var name="baiduMap";return(0,_directiveDef.def)(name,{restrict:"E",scope:{options:"=",ak:"@",offline:"=",onMapLoaded:"&"},link:function($scope,element,attrs){var opts=_angular2.default.extend({},_defaults.defaultOpts,$scope.options),offlineOpts=_angular2.default.extend({},_defaults.defaultOfflineOpts,$scope.offline);$scope.offlineWords=offlineOpts.txt,(0,_validator.validator)($scope.ak,"ak must not be empty"),(0,_validator.validator)(opts.center,"options.center must be set"),(0,_validator.validator)(opts.center.longitude,"options.center.longitude must be set"),(0,_validator.validator)(opts.center.latitude,"options.center.latitude must be set"),(0,_validator.validator)(opts.city,"options.city must be set"),(0,_baiduScriptLoader.loader)($scope.ak,offlineOpts,function(){var map=(0,_map.createInstance)(opts,element);$scope.onMapLoaded({map:map});var previousMarkers=[];(0,_map.redrawMarkers)(map,previousMarkers,opts),$scope.$watch("options.center",function(newValue,oldValue){opts=$scope.options,map.centerAndZoom(new BMap.Point(opts.center.longitude,opts.center.latitude),opts.zoom),(0,_map.redrawMarkers)(map,previousMarkers,opts)},!0),$scope.$watch("options.markers",function(newValue,oldValue){(0,_map.redrawMarkers)(map,previousMarkers,opts)},!0)}),$scope.divStyle=_offline.divStyle,$scope.labelStyle=_offline.labelStyle,setTimeout(function(){var $label=document.querySelector("baidu-map div label");$scope.labelStyle.marginTop=$label.clientHeight/-2+"px",$scope.labelStyle.marginLeft=$label.clientWidth/-2+"px",$scope.$apply()})},template:'<div ng-style="divStyle"><label ng-style="labelStyle">{{ offlineWords }}</label></div>'}),name}()},function(module,exports){module.exports=__WEBPACK_EXTERNAL_MODULE_1__},function(module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});exports.defaultOpts={navCtrl:!0,scaleCtrl:!0,overviewCtrl:!0,enableScrollWheelZoom:!0,zoom:10},exports.defaultOfflineOpts={retryInterval:3e4,txt:"OFFLINE"}},function(module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});exports.validator=function(prop,desc){if(!prop)throw new Error(desc)}},function(module,exports,__webpack_require__){"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.def=void 0;var _angular=__webpack_require__(1),_angular2=_interopRequireDefault(_angular);exports.def=function(name,ddo){_angular2.default.module(name,[]).directive(name,[function(){return ddo}])}},function(module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});exports.loader=function(ak,offlineOpts,callback){var MAP_URL="//api.map.baidu.com/api?v=2.0&ak="+ak+"&callback=baidumapinit&s="+("https:"===location.protocol?1:0),baiduMap=window.baiduMap;if(baiduMap&&"loading"===baiduMap.status)return baiduMap.callbacks.push(callback);if(baiduMap&&"loaded"===baiduMap.status)return callback();window.baiduMap={status:"loading",callbacks:[]},window.baidumapinit=function(){window.baiduMap.status="loaded",callback(),window.baiduMap.callbacks.forEach(function(cb){return cb()}),window.baiduMap.callbacks=[]};var createTag=function createTag(){var script=document.createElement("script");script.type="text/javascript",script.src=MAP_URL,script.onerror=function(){Array.prototype.slice.call(document.querySelectorAll("baidu-map div")).forEach(function(node){node.style.opacity=1}),document.body.removeChild(script),setTimeout(createTag,offlineOpts.retryInterval)},document.body.appendChild(script)};createTag()}},function(module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});exports.divStyle={width:"100%",height:"100%",backgroundColor:"#E6E6E6",position:"relative",opacity:0},exports.labelStyle={fontSize:"30px",position:"absolute",top:"50%",marginTop:0,left:"50%",marginLeft:0}},function(module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var createMarker=(exports.createInstance=function(opts,element){var map=new BMap.Map(element[0]);return map.centerAndZoom(new BMap.Point(opts.center.longitude,opts.center.latitude),opts.zoom),opts.navCtrl&&map.addControl(new BMap.NavigationControl),opts.scaleCtrl&&map.addControl(new BMap.ScaleControl),opts.overviewCtrl&&map.addControl(new BMap.OverviewMapControl),opts.enableScrollWheelZoom&&map.enableScrollWheelZoom(),map.setCurrentCity(opts.city),map},exports.createMarker=function(marker,pt){if(marker.icon){var icon=new BMap.Icon(marker.icon,new BMap.Size(marker.width,marker.height));return new BMap.Marker(pt,{icon:icon})}return new BMap.Marker(pt)});exports.redrawMarkers=function(map,previousMarkers,opts){previousMarkers.forEach(function(_ref){var marker=_ref.marker,listener=_ref.listener;marker.removeEventListener("click",listener),map.removeOverlay(marker)}),previousMarkers.length=0,opts.markers&&opts.markers.forEach(function(marker){var marker2=createMarker(marker,new BMap.Point(marker.longitude,marker.latitude));map.addOverlay(marker2);var previousMarker={marker:marker2,listener:null};if(previousMarkers.push(previousMarker),marker.title||marker.content){var msg="<p>"+(marker.title||"")+"</p><p>"+(marker.content||"")+"</p>",infoWindow2=new BMap.InfoWindow(msg,{enableMessage:!!marker.enableMessage});previousMarker.listener=function(){this.openInfoWindow(infoWindow2)},marker2.addEventListener("click",previousMarker.listener)}})}}])})},{angular:9}],7:[function(require,module,exports){"undefined"!=typeof module&&"undefined"!=typeof exports&&module.exports===exports&&(module.exports="ui.router"),function(window,angular,undefined){"use strict";function inherit(parent,extra){return extend(new(extend(function(){},{prototype:parent})),extra)}function merge(dst){return forEach(arguments,function(obj){obj!==dst&&forEach(obj,function(value,key){dst.hasOwnProperty(key)||(dst[key]=value)})}),dst}function ancestors(first,second){var path=[];for(var n in first.path){if(first.path[n]!==second.path[n])break;path.push(first.path[n])}return path}function objectKeys(object){if(Object.keys)return Object.keys(object);var result=[];return forEach(object,function(val,key){result.push(key)}),result}function indexOf(array,value){if(Array.prototype.indexOf)return array.indexOf(value,Number(arguments[2])||0);var len=array.length>>>0,from=Number(arguments[2])||0;for(from=from<0?Math.ceil(from):Math.floor(from),from<0&&(from+=len);from<len;from++)if(from in array&&array[from]===value)return from;return-1}function inheritParams(currentParams,newParams,$current,$to){var parentParams,parents=ancestors($current,$to),inherited={},inheritList=[];for(var i in parents)if(parents[i]&&parents[i].params&&(parentParams=objectKeys(parents[i].params),parentParams.length))for(var j in parentParams)indexOf(inheritList,parentParams[j])>=0||(inheritList.push(parentParams[j]),inherited[parentParams[j]]=currentParams[parentParams[j]]);return extend({},inherited,newParams)}function equalForKeys(a,b,keys){if(!keys){keys=[];for(var n in a)keys.push(n)}for(var i=0;i<keys.length;i++){var k=keys[i];if(a[k]!=b[k])return!1}return!0}function filterByKeys(keys,values){var filtered={};return forEach(keys,function(name){filtered[name]=values[name]}),filtered}function pick(obj){var copy={},keys=Array.prototype.concat.apply(Array.prototype,Array.prototype.slice.call(arguments,1));return forEach(keys,function(key){key in obj&&(copy[key]=obj[key])}),copy}function omit(obj){var copy={},keys=Array.prototype.concat.apply(Array.prototype,Array.prototype.slice.call(arguments,1));for(var key in obj)indexOf(keys,key)==-1&&(copy[key]=obj[key]);return copy}function filter(collection,callback){var array=isArray(collection),result=array?[]:{};return forEach(collection,function(val,i){callback(val,i)&&(result[array?result.length:i]=val)}),result}function map(collection,callback){var result=isArray(collection)?[]:{};return forEach(collection,function(val,i){result[i]=callback(val,i)}),result}function silenceUncaughtInPromise(promise){return promise.then(undefined,function(){})&&promise}function $Resolve($q,$injector){var VISIT_IN_PROGRESS=1,VISIT_DONE=2,NOTHING={},NO_DEPENDENCIES=[],NO_LOCALS=NOTHING,NO_PARENT=extend($q.when(NOTHING),{$$promises:NOTHING,$$values:NOTHING});this.study=function(invocables){function visit(value,key){if(visited[key]!==VISIT_DONE){if(cycle.push(key),visited[key]===VISIT_IN_PROGRESS)throw cycle.splice(0,indexOf(cycle,key)),new Error("Cyclic dependency: "+cycle.join(" -> "));if(visited[key]=VISIT_IN_PROGRESS,isString(value))plan.push(key,[function(){return $injector.get(value)}],NO_DEPENDENCIES);else{var params=$injector.annotate(value);forEach(params,function(param){param!==key&&invocables.hasOwnProperty(param)&&visit(invocables[param],param)}),plan.push(key,value,params)}cycle.pop(),visited[key]=VISIT_DONE}}function isResolve(value){return isObject(value)&&value.then&&value.$$promises}if(!isObject(invocables))throw new Error("'invocables' must be an object");var invocableKeys=objectKeys(invocables||{}),plan=[],cycle=[],visited={};return forEach(invocables,visit),invocables=cycle=visited=null,function(locals,parent,self){function done(){--wait||(merged||merge(values,parent.$$values),result.$$values=values,result.$$promises=result.$$promises||!0,delete result.$$inheritedValues,resolution.resolve(values))}function fail(reason){result.$$failure=reason,resolution.reject(reason)}function invoke(key,invocable,params){function onfailure(reason){invocation.reject(reason),fail(reason)}function proceed(){if(!isDefined(result.$$failure))try{invocation.resolve($injector.invoke(invocable,self,values)),invocation.promise.then(function(result){values[key]=result,done()},onfailure)}catch(e){onfailure(e)}}var invocation=$q.defer(),waitParams=0;forEach(params,function(dep){promises.hasOwnProperty(dep)&&!locals.hasOwnProperty(dep)&&(waitParams++,promises[dep].then(function(result){values[dep]=result,--waitParams||proceed()},onfailure))}),waitParams||proceed(),promises[key]=invocation.promise}if(isResolve(locals)&&self===undefined&&(self=parent,parent=locals,locals=null),locals){if(!isObject(locals))throw new Error("'locals' must be an object")}else locals=NO_LOCALS;if(parent){if(!isResolve(parent))throw new Error("'parent' must be a promise returned by $resolve.resolve()")}else parent=NO_PARENT;var resolution=$q.defer(),result=resolution.promise,promises=result.$$promises={},values=extend({},locals),wait=1+plan.length/3,merged=!1;if(isDefined(parent.$$failure))return fail(parent.$$failure),result;parent.$$inheritedValues&&merge(values,omit(parent.$$inheritedValues,invocableKeys)),extend(promises,parent.$$promises),parent.$$values?(merged=merge(values,omit(parent.$$values,invocableKeys)),result.$$inheritedValues=omit(parent.$$values,invocableKeys),done()):(parent.$$inheritedValues&&(result.$$inheritedValues=omit(parent.$$inheritedValues,invocableKeys)),parent.then(done,fail));for(var i=0,ii=plan.length;i<ii;i+=3)locals.hasOwnProperty(plan[i])?done():invoke(plan[i],plan[i+1],plan[i+2]);return result}},this.resolve=function(invocables,locals,parent,self){return this.study(invocables)(locals,parent,self)}}function $TemplateFactory($http,$templateCache,$injector){this.fromConfig=function(config,params,locals){return isDefined(config.template)?this.fromString(config.template,params):isDefined(config.templateUrl)?this.fromUrl(config.templateUrl,params):isDefined(config.templateProvider)?this.fromProvider(config.templateProvider,params,locals):null},this.fromString=function(template,params){return isFunction(template)?template(params):template},this.fromUrl=function(url,params){return isFunction(url)&&(url=url(params)),null==url?null:$http.get(url,{cache:$templateCache,headers:{Accept:"text/html"}}).then(function(response){return response.data})},this.fromProvider=function(provider,params,locals){return $injector.invoke(provider,null,locals||{params:params})}}function UrlMatcher(pattern,config,parentMatcher){function addParameter(id,type,config,location){if(paramNames.push(id),parentParams[id])return parentParams[id];if(!/^\w+([-.]+\w+)*(?:\[\])?$/.test(id))throw new Error("Invalid parameter name '"+id+"' in pattern '"+pattern+"'");if(params[id])throw new Error("Duplicate parameter name '"+id+"' in pattern '"+pattern+"'");return params[id]=new $$UMFP.Param(id,type,config,location),params[id]}function quoteRegExp(string,pattern,squash,optional){var surroundPattern=["",""],result=string.replace(/[\\\[\]\^$*+?.()|{}]/g,"\\$&");if(!pattern)return result;switch(squash){case!1:surroundPattern=["(",")"+(optional?"?":"")];break;case!0:result=result.replace(/\/$/,""),surroundPattern=["(?:/(",")|/)?"];break;default:surroundPattern=["("+squash+"|",")?"]}return result+surroundPattern[0]+pattern+surroundPattern[1]}function matchDetails(m,isSearch){var id,regexp,segment,type,cfg;return id=m[2]||m[3],cfg=config.params[id],segment=pattern.substring(last,m.index),regexp=isSearch?m[4]:m[4]||("*"==m[1]?".*":null),regexp&&(type=$$UMFP.type(regexp)||inherit($$UMFP.type("string"),{pattern:new RegExp(regexp,config.caseInsensitive?"i":undefined)})),{id:id,regexp:regexp,segment:segment,type:type,cfg:cfg}}config=extend({params:{}},isObject(config)?config:{});var m,placeholder=/([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g,searchPlaceholder=/([:]?)([\w\[\].-]+)|\{([\w\[\].-]+)(?:\:\s*((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g,compiled="^",last=0,segments=this.segments=[],parentParams=parentMatcher?parentMatcher.params:{},params=this.params=parentMatcher?parentMatcher.params.$$new():new $$UMFP.ParamSet,paramNames=[];this.source=pattern;for(var p,param,segment;(m=placeholder.exec(pattern))&&(p=matchDetails(m,!1),!(p.segment.indexOf("?")>=0));)param=addParameter(p.id,p.type,p.cfg,"path"),compiled+=quoteRegExp(p.segment,param.type.pattern.source,param.squash,param.isOptional),segments.push(p.segment),last=placeholder.lastIndex;segment=pattern.substring(last);var i=segment.indexOf("?");if(i>=0){var search=this.sourceSearch=segment.substring(i);if(segment=segment.substring(0,i),this.sourcePath=pattern.substring(0,last+i),search.length>0)for(last=0;m=searchPlaceholder.exec(search);)p=matchDetails(m,!0),param=addParameter(p.id,p.type,p.cfg,"search"),last=placeholder.lastIndex}else this.sourcePath=pattern,this.sourceSearch="";compiled+=quoteRegExp(segment)+(config.strict===!1?"/?":"")+"$",segments.push(segment),this.regexp=new RegExp(compiled,config.caseInsensitive?"i":undefined),this.prefix=segments[0],this.$$paramNames=paramNames}function Type(config){extend(this,config)}function $UrlMatcherFactory(){function valToString(val){return null!=val?val.toString().replace(/(~|\/)/g,function(m){return{"~":"~~","/":"~2F"}[m]}):val}function valFromString(val){return null!=val?val.toString().replace(/(~~|~2F)/g,function(m){return{"~~":"~","~2F":"/"}[m]}):val}function getDefaultConfig(){return{strict:isStrictMode,caseInsensitive:isCaseInsensitive}}function isInjectable(value){return isFunction(value)||isArray(value)&&isFunction(value[value.length-1])}function flushTypeQueue(){for(;typeQueue.length;){var type=typeQueue.shift();if(type.pattern)throw new Error("You cannot override a type's .pattern at runtime.");angular.extend($types[type.name],injector.invoke(type.def))}}function ParamSet(params){extend(this,params||{})}$$UMFP=this;var injector,isCaseInsensitive=!1,isStrictMode=!0,defaultSquashPolicy=!1,$types={},enqueue=!0,typeQueue=[],defaultTypes={string:{encode:valToString,decode:valFromString,is:function(val){return null==val||!isDefined(val)||"string"==typeof val},pattern:/[^\/]*/},int:{encode:valToString,decode:function(val){return parseInt(val,10)},is:function(val){return isDefined(val)&&this.decode(val.toString())===val},pattern:/\d+/},bool:{encode:function(val){return val?1:0},decode:function(val){return 0!==parseInt(val,10)},is:function(val){return val===!0||val===!1},pattern:/0|1/},date:{encode:function(val){return this.is(val)?[val.getFullYear(),("0"+(val.getMonth()+1)).slice(-2),("0"+val.getDate()).slice(-2)].join("-"):undefined},decode:function(val){if(this.is(val))return val;var match=this.capture.exec(val);return match?new Date(match[1],match[2]-1,match[3]):undefined},is:function(val){return val instanceof Date&&!isNaN(val.valueOf())},equals:function(a,b){return this.is(a)&&this.is(b)&&a.toISOString()===b.toISOString()},pattern:/[0-9]{4}-(?:0[1-9]|1[0-2])-(?:0[1-9]|[1-2][0-9]|3[0-1])/,capture:/([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])/},json:{encode:angular.toJson,decode:angular.fromJson,is:angular.isObject,equals:angular.equals,pattern:/[^\/]*/},any:{encode:angular.identity,decode:angular.identity,equals:angular.equals,pattern:/.*/}};$UrlMatcherFactory.$$getDefaultValue=function(config){if(!isInjectable(config.value))return config.value;if(!injector)throw new Error("Injectable functions cannot be called at configuration time");return injector.invoke(config.value)},this.caseInsensitive=function(value){return isDefined(value)&&(isCaseInsensitive=value),isCaseInsensitive},this.strictMode=function(value){return isDefined(value)&&(isStrictMode=value),isStrictMode},this.defaultSquashPolicy=function(value){if(!isDefined(value))return defaultSquashPolicy;if(value!==!0&&value!==!1&&!isString(value))throw new Error("Invalid squash policy: "+value+". Valid policies: false, true, arbitrary-string");return defaultSquashPolicy=value,
